...
public class SushiItems {
    ...
    public static final Item NIGIRI = new Item(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(4).saturationModifier(8f).build()));
    public static final Item EGG_SUSHI = new Item(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(4).saturationModifier(8f).build()));
    ...
    public static void registerItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier("foodmod","nigiri"), NIGIRI);
        Registry.register(Registry.ITEM, new Identifier("foodmod", "egg_sushi"), EGG_SUSHI);
